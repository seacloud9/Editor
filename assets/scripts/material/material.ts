...
class /*{__shader_class_name__}*/AMaterialDefines extends MaterialDefines {
...
export class /*{__shader_class_name__}*/AMaterial extends PushMaterial {
    ...
    public clone(name: string): /*{__shader_class_name__}*/AMaterial {
        return SerializationHelper.Clone</*{__shader_class_name__}*/AMaterial>(() => new /*{__shader_class_name__}*/AMaterial(name, this.getScene()), this);
    }

    public serialize(): any {
        var serializationObject = SerializationHelper.Serialize(this);
        serializationObject.customType = "BABYLON./*{__shader_class_name__}*/AMaterial";
        return serializationObject;
    }

    public getClassName(): string {
        return "/*{__shader_class_name__}*/AMaterial";
    }

    // Statics
    public static Parse(source: any, scene: Scene, rootUrl: string): /*{__shader_class_name__}*/AMaterial {
        return SerializationHelper.Parse(() => new /*{__shader_class_name__}*/AMaterial(source.name, scene), source, scene, rootUrl);
    }
}
